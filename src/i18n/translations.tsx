...
export const translations: Record<Locale, Dict> = {
  en: {
    ...
    about: {
      ...
      p3a: "Her piece, Metamorfosis, was the winner in the",
      bienalAbout: " Unique Piece Competition 2026 in Navarrete, La Rioja, Spain.",
    ...
    work: {
      eyebrow: "Selected work · 2022 — Present",
  ...
  es: {
    ...
    about: {
      ...
      p3a: "Su pieza, Metamorfosis, fue la ganadora del",
      bienalAbout: " Concurso de la Pieza Única 2026 en Navarrete, La Rioja, España.",
    ...
    work: {
      eyebrow: "Obra seleccionada · 2022 — Actualidad",
      h1a: "La colección de",
      h1b: " formas huecas.",
      intro:
  ...
  it: {
    ...
    about: {
      ...
      p3a: "Il suo pezzo, Metamorfosi, è stato il vincitore del",
      bienalAbout: " Concorso di Pezzi Unici 2026 a Navarrete, La Rioja, Spagna.",
